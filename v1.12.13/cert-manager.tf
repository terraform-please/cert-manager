  ...
  manifest = {
    ...
    "metadata" = {
      "labels" = {
        ...
        "app.kubernetes.io/version" = "v1.12.13"
      }
          ...
          "containers" = [
            {
              ...
              "image" = "quay.io/jetstack/cert-manager-cainjector:v1.12.13"
          ...
          "containers" = [
            {
              "args" = [
                ...
                "--leader-election-namespace=kube-system",
                "--acme-http01-solver-image=quay.io/jetstack/cert-manager-acmesolver:v1.12.13",
              ...
              "image" = "quay.io/jetstack/cert-manager-controller:v1.12.13"
              "imagePullPolicy" = "IfNotPresent"
          ...
          "containers" = [
            {
              ...
              "image" = "quay.io/jetstack/cert-manager-webhook:v1.12.13"
              "imagePullPolicy" = "IfNotPresent"
              "livenessProbe" = {
                "failureThreshold" = 3
                "httpGet" = {
