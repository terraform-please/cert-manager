  ...
  manifest = {
    ...
    "metadata" = {
      "labels" = {
        ...
        "app.kubernetes.io/version" = "v1.14.0-alpha.1"
      }
          ...
          "containers" = [
            {
              ...
              "image" = "quay.io/jetstack/cert-manager-cainjector:v1.14.0-alpha.1"
          ...
          "containers" = [
            {
              "args" = [
                ...
                "--leader-election-namespace=kube-system",
                "--acme-http01-solver-image=quay.io/jetstack/cert-manager-acmesolver:v1.14.0-alpha.1",
              ...
              "image" = "quay.io/jetstack/cert-manager-controller:v1.14.0-alpha.1"
              "imagePullPolicy" = "IfNotPresent"
              "livenessProbe" = {
                "failureThreshold" = 8
                "httpGet" = {
          ...
          "containers" = [
            {
              ...
              "image" = "quay.io/jetstack/cert-manager-webhook:v1.14.0-alpha.1"
              "imagePullPolicy" = "IfNotPresent"
              "livenessProbe" = {
                "failureThreshold" = 3
                "httpGet" = {
